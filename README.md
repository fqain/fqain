...
<p align="left">
  <img src="https://skillicons.dev/icons?i=python,java,js,ts,html,css,cpp,bash,linux,kali,git,github,docker,kubernetes,aws,gcp,azure,terraform,nginx,cloudflare,vscode,figma,firebase,react,nodejs,mongodb&theme=light&perline=6" alt="Skills"/>
</p>
